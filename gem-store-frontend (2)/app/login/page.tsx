...
export default function LoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // No setToken() anymore — the backend sets the access/refresh
      // cookies directly via Set-Cookie headers on this same response;
      // there's nothing left for client JS to do with a token.
